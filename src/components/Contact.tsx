...
import { Phone, Mail, MapPin, Calendar, Clock, Star, Shield } from 'lucide-react';
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="mt-6 text-center border-t border-blue-100 pt-4">
                  ...
                  <p className="text-xs text-gray-500 max-w-xs mx-auto leading-snug">
                    We respect your privacy — your contact details will only be used to respond to your inquiry and will never be sold or distributed.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-50 p-6 rounded-lg border-2 border-orange-200">
                ...
                <p className="text-gray-600 mb-4">
                  Book your free estimate appointment online
                </p>
            ...
            <div className="lg:col-span-2">
              <div className="bg-gradient-to-br from-blue-50 to-orange-50 p-8 rounded-lg border-2 border-blue-100">
                <div className="text-center">
                  ...
                  <div className="mt-6">
                    <a
                      href="https://www.google.com/search?q=Fence+Masters+DFW&rlz=1C1CHBF_enUS1234US1234#lrd=0x864c19f77192b5ed:0x123456789abcdef0,1,,,"
                      target="_blank"
                      rel="noopener noreferrer"
                      ...
                      <div className="flex items-center">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`w-4 h-4 ${
                              i < 5 ? 'text-yellow-200 fill-current' : 'text-yellow-200'
                            }`}
                          />
                        ))}
                      </div>
