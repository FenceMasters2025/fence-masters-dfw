        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Since 2011, Fence Masters DFW has been the go-to choice for residential fencing solutions throughout the Dallas-Fort Worth metroplex. Our commitment to quality craftsmanship and exceptional customer service has made us the region's most trusted residential fencing contractor.
            </p>
